...
export const postsGbms: Post[] = [
  {
    ...
    body: [
      ...
      },
      {
        type: "img",
        src: "/img/gbms-ui.jpg",
        alt: "Ekran tworzenia Grok Bota z podpowiedzią Inbox Triage",
        caption: "Inbox Triage było w sugestiach od początku. Teraz ma prawdziwą skrzynkę.",
      },
      {
        type: "p",
      ...
      {
        type: "img",
        src: "/img/gbms-kanal.jpg",
        alt: "Schemat: jeden komputer w chmurze, kilka botów, wspólny stan i loginy",
        caption: "Jeden komputer, kilka botów, wspólny stan. Dlatego kanały mają znaczenie.",
        contain: true,
      },
      {
        type: "p",
      ...
      },
      {
        ...
        caption: "Mail i kalendarz były na dole listy. Właśnie weszły do wtyczek.",
      },
      {
        type: "p",
