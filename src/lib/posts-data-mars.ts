...
export const postsMars: Post[] = [
  {
    ...
    body: [
      {
        type: "p",
        text: "[Dima Zeniuk](https://x.com/DimaZeniuk/status/2094647676927087024) napisał, że budowa bazy na Marsie będzie jednym z największych wyzwań w historii ludzkości. [Musk](https://x.com/elonmusk/status/2094849443506122939) to potwierdził. Na Marsa da się lecieć tylko gdy planety zgrają się co 26 miesięcy, a lot trwa sześć.",
      },
      {
        type: "img",
        src: "/img/mars-dima.jpg",
        alt: "Grafika Dimy Zeniuka: baza na Marsie",
      ...
      },
      {
        ...
        alt: "Wizja SpaceX Mars Base Alpha: Starshipy na padzie, kopuła, łazik, droga",
        caption: "Base Alpha.",
      },
      {
        type: "img",
        src: "/img/mars-jezero.jpg",
        alt: "Prawdziwy Mars: wzniesienie w kraterze Jezero sfotografowane przez Perseverance",
      ...
      {
        type: "img",
        src: "/img/mars-kolonia.jpg",
        alt: "Widok z góry na kolonię marsjańską SpaceX: kopuła, tunele, trzy Starshipy",
        caption: "Kolonia z góry. To wciąż rysunek.",
      },
      {
        type: "p",
