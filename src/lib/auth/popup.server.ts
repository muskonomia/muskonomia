...
function completionHtml(message: PopupMessage): string {
  ...
  return `<!doctype html><html><body><script type="application/json" id="m">${payload}</script><script>
(function(){var el=document.getElementById("m");var msg={source:"grok-auth-popup",token:null};
